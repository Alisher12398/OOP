...
public class Admin extends User {
	...
	public static void addUser() throws IOException {
		System.out.println("Ââåäèòå íîâîãî ïîëüçîâàòåëÿ â ôîðìàòå:" + "\n" + "Èìÿ" + "\n" + "Ôàìèëèÿ" + "\n" + "ID" + "\n" + "Ïàðîëü");
		...
		BufferedReader bf = new BufferedReader(new FileReader("C:\\Users\\Àëèøåð\\eclipse-workspace\\Project2\\output.txt"));
		BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\Àëèøåð\\eclipse-workspace\\Project2\\output.txt"));
		//File file = new File("C:\\Users\\Àëèøåð\\eclipse-workspace\\Project2\\output2.txt");
	...
	public static void updateUser() throws IOException {
		System.out.println("Ââåäèòå ID ñòóäåíòà");
		String ID2;
		Scanner in = new Scanner(System.in);
		ID2=in.nextLine();
				
		BufferedReader bf1 = new BufferedReader(new FileReader("C:\\Users\\Àëèøåð\\eclipse-workspace\\Project2\\output.txt"));
		BufferedWriter bw1 = new BufferedWriter(new FileWriter("C:\\Users\\Àëèøåð\\eclipse-workspace\\Project2\\output.txt"));
		
		for (int i=0; i<userDataList.size(); i++) {
			if (userDataList.get(i).equals(ID2)) {
				System.out.println("Ââåäèòå ïîëå, êîòîðûå õîòèòå çàìåíèòü");
